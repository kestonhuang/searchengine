<html>
<head>
	<title>UQAuction: Edit your photos</title>
...
<body>
<div class="main">
	<p>Edit your photos of your items before you list them for sales here!</p>
	<form action="<?php echo base_url('private_area/zip_download') ?>">
		<input type="submit" value="Download processed images" />
	</form>
	<div class="data">
		<div class="page">
			<div id="content">
				<h2 id="form_head">Edit your photos</h2><br/>
				<hr>
				<div id="form_input">
					<?php
					$data = array(
					...
					// Form open
					echo form_open('private_area/value', $data);
